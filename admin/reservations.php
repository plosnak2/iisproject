            ...
            <form method='get'>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <option <?php if(count($_GET) != 0 && $_GET['status'] == 'Vytvorená'){echo 'selected';}?>>Vytvorená</option>
                        <option <?php if(count($_GET) != 0 && $_GET['status'] == 'Vyzdvihnutá'){echo 'selected';}?>>Vyzdvihnutá</option>
